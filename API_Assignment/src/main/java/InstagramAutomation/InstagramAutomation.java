...
public class InstagramAutomation {
    ...
    public static void main(String[] args) throws InterruptedException, IOException, AWTException {
        ...
        //Login
        driver.findElement(By.xpath("//*[@aria-label = \"Phone number, username, or email\"]")).sendKeys("testingtestdata");
        Thread.sleep(100);
        driver.findElement(By.xpath("//*[@aria-label = \"Phone number, username, or email\"]")).clear();
        Thread.sleep(100);
        driver.findElement(By.xpath("//*[@aria-label=\"Password\"]")).sendKeys("testingtestdatablz");
        driver.findElement(By.xpath("//*[@aria-label=\"Password\"]")).clear();
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()=\"Save Info\"]")));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[text()=\"Create\"]")));
        driver.findElement(By.xpath("//span[text()=\"Create\"]")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//button[text()=\"Select from computer\"]")));
        driver.findElement(By.xpath("//button[text()=\"Select from computer\"]")).click();
        Thread.sleep(1000);
        Runtime runtime = Runtime.getRuntime();
        Thread.sleep(1000);
        Process process = runtime.exec("C:\\Users\\HP\\OneDrive\\Documents\\InstagramAddPost.exe");
        Thread.sleep(1000);
